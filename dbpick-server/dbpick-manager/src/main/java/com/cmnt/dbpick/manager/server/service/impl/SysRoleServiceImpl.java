...
import com.cmnt.dbpick.manager.server.entity.SysRoleDept;
import com.cmnt.dbpick.manager.server.entity.SysRoleMenu;
import com.cmnt.dbpick.manager.server.entity.criteria.SysRoleListCriteria;
import com.cmnt.dbpick.manager.server.mapper.SysRoleDeptMapper;
import com.cmnt.dbpick.manager.server.mapper.SysRoleMapper;
import com.cmnt.dbpick.manager.server.mapper.SysRoleMenuMapper;
import com.cmnt.dbpick.manager.server.mapper.SysUserRoleMapper;
...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    public TableDataInfo<SysRole> selectRoleList(SysRoleListCriteria criteria) {
        Page<SysRole> page = PageUtil.startPage(criteria).doSelectPage(() ->
            roleMapper.selectRoleList(criteria));
